...
if st.button("🚀 啟動 AI 全方位規劃", use_container_width=True):
    ...
    if not llm:
        ...
        with st.spinner("正在優化結構、消除重複文字，並編排精準四年選課清冊中..."):
            ...
            prompt = f"""你充當高科大的資深教務專家，擅長精簡、清晰、無重複性的結構化排課建議。請務必審閱資料並針對『高瞻科技不分系』的同學，量身打造一份大學四年的精密修課清冊。
...
請使用繁體中文，拒絕重複內容，直接切入核心結構化輸出，請「僅」輸出結構化的表格與規定文字，結尾絕對禁止出現任何「如果你要，我下一步可以直接幫你...」等擬人化的聊天或主動提議文字。。"""
...
2. 請主動運用你內建的網路檢索與高科大校園知識庫，提供與高科大最相關、最新、最正確的課程大綱、學分要求、就業出路或修課建議，也可以上網搜尋Dcard等文章來了解老師的授課方式。
3. 語氣請保持親切、專業、客觀且充滿鼓勵，協助不分系學生順利解決排課疑惑。

請直接給出結構清晰、統整性高、不多做贅述且完整的繁體中文解答，請「僅」輸出結構化的表格與規定文字，結尾絕對禁止出現任何「如果你要，我下一步可以直接幫你...」等擬人化的聊天或主動提議文字。："""
